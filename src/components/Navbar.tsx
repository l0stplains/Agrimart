    ...
    <header className="fixed top-0 w-[min(100%,_1024px)] h-[80px] rounded-b-3xl bg-white flex justify-between items-center gap-4 p-6 text-black z-30">
      <div className="md:hidden">
        <button className="navbar-toggler text-black" onClick={handleNavbarToggle}>
          <Image src="/menu-burger.svg" alt="Menu Icon" width={40} height={40} />
        </button>
        <div
          className={`transition-all ease-out absolute top-0 left ${
        ...
        >
          ...
          >
           <Image src="/cross.svg" alt="Close Icon" width={36} height={36} /> 
          </button>
        ...
        <div
          className={`transition-all ease-out absolute top-0 ${
            showNavbar ? "" : "hidden"
